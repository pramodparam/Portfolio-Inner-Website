    ...
    return (
        <div className="site-page-content">
            ...
            <div style={styles.container}>
                <h1 style={styles.mainHeader}>Skills</h1>
...
const SkillSection: React.FC<{ title: string; skills: SkillProps[] }> = ({ title, skills }) => (
...
const Others: React.FC = () => (
    <SkillSection
        ...
        skills={[
            ...
            { name: 'VS Code', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/512px-Visual_Studio_Code_1.35_icon.svg.png?20210804221519' },
